...
document.children[0].children[1].children[0].innerText = "Learning Dom";

//    - Select the first `li` element inside the `ul` with class `topics` and change the innerText to `all about document`

document.children[0].children[1].children[5].children[0].innerText = "All about Documents";

//    - Select the input element with name `email`

document.children[0].children[1].children[6].children[3].innerText = "Changed";

// 3. Log the number (using console.log) of children of all the `li` element inside the ul with class `topics`

console.log(document.children[0].children[1].children[5]);
...
console.log(`The total number of btn is ${allBtn.length}`);
...
topics.previousElementSibling.innerText = 'Learning to DOM';
...
typeof fieldsetElm.parentElement;
