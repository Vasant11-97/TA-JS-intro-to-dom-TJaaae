...
let imageClass = document.querySelectorAll(".image");
imageClass.forEach(ele => ele.style.border = "2px solid purple");
...
allHrsArray.forEach((ele) => ele.style.border = "2px dashed black");
...
let oddBox = document.querySelectorAll('.box');

let oddBoxArray = Array.from(oddBox);

oddBoxArray.forEach((ele, index) => 
{
  if(index % 2 !== 0){
...
document.querySelector(".six").remove("awesome-box");
